...
public class ViewCompat {
    ...
    static class HCViewCompatImpl extends GBViewCompatImpl {
        ...
        @Override public void setLayerType(View view, int layerType, Paint paint) {
            ViewCompat.setLayerType(view, layerType, paint);
        }
        @Override public int getLayerType(View view)  {
            return ViewCompat.getLayerType(view);
        }
        @Override
        public void setLayerPaint(View view, Paint paint) {
    ...
    static class ICSViewCompatImpl extends HCViewCompatImpl {
        ...
        @Override
        public boolean canScrollVertically(View v, int direction) {
            return android.support.v4.view.ViewCompat.canScrollVertically(v, direction);
        }
        @Override
        public void onPopulateAccessibilityEvent(View v, AccessibilityEvent event) {
            android.support.v4.view.ViewCompat.onPopulateAccessibilityEvent(v, event);
        }
        @Override
        public void onInitializeAccessibilityEvent(View v, AccessibilityEvent event) {
            android.support.v4.view.ViewCompat.onInitializeAccessibilityEvent(v, event);
        }
       /* @Override
        public void onInitializeAccessibilityNodeInfo(View v, AccessibilityNodeInfoCompat info) {
            ViewCompat.onInitializeAccessibilityNodeInfo(v, info.getInfo());
        }
        @Override
        public void setAccessibilityDelegate(View v, AccessibilityDelegateCompat delegate) {
            ViewCompat.setAccessibilityDelegate(v, delegate.getBridge());
        }*/
    }
    ...
    static class JBViewCompatImpl extends ICSViewCompatImpl {
        @Override
        public boolean hasTransientState(View view) {
            return android.support.v4.view.ViewCompat.hasTransientState(view);
        }
        @Override
        public void setHasTransientState(View view, boolean hasTransientState) {
            android.support.v4.view.ViewCompat.setHasTransientState(view, hasTransientState);
        }
        @Override
        public void postInvalidateOnAnimation(View view) {
